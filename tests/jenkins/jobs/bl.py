...
def set_directories(job_obj):
    ...
    if job_obj.machine == 'hera':
        ...
        workdir = '/glade/scratch/epicufsrt/autort/tests/pr'
...
def run_regression_test(job_obj, pr_repo_loc):
    ...
    if job_obj.compiler == 'gnu' and and job_obj.machine != 'hera':
        ...
        rt_command = [[f'export RT_COMPILER="{job_obj.compiler}" && cd tests '
                       ...
                       pr_repo_loc]]
    elif job_obj.compiler == 'intel' and and job_obj.machine != 'hera':
        rt_command = [[f'export RT_COMPILER="{job_obj.compiler}" && cd tests '
